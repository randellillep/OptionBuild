...
export const strategyTemplates: ExtendedStrategy[] = [
  ...
  {
    name: "Covered Call (Option Only)",
    description: "The short call component of a covered call strategy. You must own 100 shares separately. This shows only the option P/L - combine with your stock position for total strategy return.",
    legs: [
      {
        id: "1",
        type: "call",
    ...
    metadata: {
      ...
      tags: ["Income", "Vol Short", "Stock Required"],
      riskLevel: "unlimited",
      profitPotential: "limited",
      maxProfit: "Premium Received",
      maxLoss: "Unlimited (option only)",
      breakeven: "Strike + Premium",
    },
  },
  {
  ...
  {
    name: "Protective Put (Option Only)",
    description: "The long put component of a protective put strategy. You must own 100 shares separately. This shows only the option P/L - combine with your stock position for total strategy return.",
    legs: [
      {
        id: "1",
        type: "put",
    ...
    metadata: {
      category: "basic",
      sentiment: ["bullish"],
      tags: ["Protection", "Vol Long", "Stock Required"],
      riskLevel: "limited",
      profitPotential: "capped",
      maxProfit: "Strike - Premium (option only)",
      maxLoss: "Premium Paid",
      breakeven: "Strike - Premium",
    },
  },
