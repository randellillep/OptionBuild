...
export interface ClosingEntry {
  ...
  expirationDate?: string; // Expiration date at time of close (immutable - doesn't move when leg expiration changes)
...
// Blog images table - stores uploaded images as base64
