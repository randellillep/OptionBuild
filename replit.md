...
- **0DTE intraday heatmap**: When `expirationDays=0` and within market hours (Mon-Fri, 9:30AM-4PM ET), generates exact-interval time columns (5min within 1hr, 10min within 3hr, 15min otherwise) to 4PM close. Uses `Intl.DateTimeFormat` with `America/New_York` timezone for DST correctness. Outside market hours/weekends, shows single column.
